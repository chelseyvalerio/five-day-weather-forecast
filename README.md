...
Task was to create a 5 day weather forecast for users to be able to see temperature, humidity, wind speed, and image of anticipated weather description for the current day and next 4 days. After a user has searched a city, the city should be logged within local storage and displayed on the DOM for user to quickly search that city again.
